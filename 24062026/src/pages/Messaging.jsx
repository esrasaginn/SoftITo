      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Departmanlar ve teknik personel arası anlık koordinasyon.
          </p>
        </div>
      </div>
        ...
        {activeContact ? (
          <div className="message-area">
            ...
            <div className="chat-thread">
              {activeThread.map((msg) => (
                <div
                  key={msg.id}
                  className={
                    msg.sender === "me" ? "bubble-sent" : "bubble-received"
                  }
                >
                  <p>{msg.content}</p>
            ...
            <form onSubmit={handleSend} className="chat-input-bar">
              <button type="button" onClick={handleAttach} className="icon-btn">
                📎
              </button>
              <input
                type="text"
          ...
          <div className="message-area flex items-center justify-center p-8">
