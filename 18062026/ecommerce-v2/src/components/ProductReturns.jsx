    ...
    <>
      <main className="tracking-container">
        ...
        <div className="tracking-card">
            ...
            <p className="value-desc">1. Yukarıdaki formdan iade talebi oluşturun</p>
            <p className="value-desc">2. Size verilecek kargo koduyla ürünü paketleyin</p>
            <p className="value-desc">3. En yakın kargo şubesine giderek paketi ücretsiz teslim edin.</p>
        </div>
      </main>
    </>
  );
